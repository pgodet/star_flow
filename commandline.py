...
def _add_special_arguments(parser):
    ...
    if checkpoint is not None:
        ...
        parser.add_argument(
            "--checkpoint_loading_strict", type=tools.str2bool, default=True)
...
def _parse_arguments():
    ...
    # -------------------------------------------------------------------------
    # Arguments inferred from datasets for inference
    # -------------------------------------------------------------------------
    _add_arguments_for_module(
        parser,
        datasets,
...
def postprocess_args(args):
    ...
    if args.inference_dataset is not None:
        dataset_classes = tools.module_classes_to_dict(datasets)
        args.inference_dataset_class = dataset_classes[args.inference_dataset]
